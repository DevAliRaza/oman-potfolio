...
export default function CircuitTrace() {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      >
        {/* Main traces */}
        <g stroke="#D4A04A" strokeWidth="1.5" opacity="0.15">
          <path d="M200 0 L200 200 L350 200 L350 350" className="circuit-line" />
          <path d="M350 350 L350 500 L500 500" className="circuit-line" />
          <path d="M100 100 L100 300 L250 300" className="circuit-line" />
          <path d="M400 0 L400 150 L500 150 L500 400" className="circuit-line" />
          <path d="M300 400 L300 600 L450 600 L450 800" className="circuit-line" />
          <path d="M150 500 L150 700 L300 700" className="circuit-line" />
        </g>

        {/* Solder pads / nodes */}
        <g fill="#D4A04A" opacity="0.2">
        ...
        {/* IC chip shapes */}
        <g stroke="#D4A04A" strokeWidth="1" opacity="0.1" fill="none">
          <rect x="330" y="330" width="40" height="40" rx="2" />
          <rect x="480" cy="480" width="40" height="40" rx="2" y="480" />
          <rect x="230" y="280" width="40" height="40" rx="2" />
        </g>

        {/* Vias */}
        <g stroke="#D4A04A" strokeWidth="1" opacity="0.12" fill="none">
